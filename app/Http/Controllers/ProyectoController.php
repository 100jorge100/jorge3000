...
class ProyectoController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('proyectos.index', compact('comunidads', 'recursos', 'empresas', 'categorias'));
    }
    ...
    public function show(string $id)
    {
        ...
        return view('proyectos.cronograma-index', compact('cronogramas', 'proyectos', 'proyecto'));
    }
